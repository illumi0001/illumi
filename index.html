...
<body>
	...
	<div class="w3-container w3-center w3-display-middle w3-animate-opacity">
		<div class="glitch-wrapper">
		<p class="glitch w3-xlarge w3-wide w3-serif" data-text="Hacked by Illumi">Hacked by Illumi</p>
	</div>
	
	<div="w3-container">
		
		<div class="glitch-wrapper">
		<p class="glitch w3-tiny w3-serif w3-wide w3-text-yellow" data-text="Please Patch your security A.S.A.P">Please Patch your security A.S.A.P</p>
		</div>
...
@-webkit-keyframes glitch-anim {
  ...
  12.5% {
    clip: rect(148px, 9999px, 140px, 0);
  }
  16.666666666666664% {
  ...
  29.166666666666668% {
    clip: rect(121px, 9999px, 41px, 0);
  }
  33.33333333333333% {
    clip: rect(138px, 9999px, 108px, 0);
  }
  37.5% {
  ...
  50% {
    clip: rect(140px, 9999px, 130px, 0);
  }
  54.166666666666664% {
  ...
  79.16666666666666% {
    clip: rect(137px, 9999px, 25px, 0);
  }
  83.33333333333334% {
    clip: rect(101px, 9999px, 130px, 0);
  }
  87.5% {
    clip: rect(135px, 9999px, 12px, 0);
  }
  91.66666666666666% {
...
@-webkit-keyframes glitch-anim-2 {
  ...
  40% {
    clip: rect(87px, 9999px, 128px, 0);
  }
  43.333333333333336% {
    clip: rect(109px, 9999px, 28px, 0);
  }
  46.666666666666664% {
    clip: rect(96px, 9999px, 83px, 0);
  }
  50% {
    clip: rect(136px, 9999px, 38px, 0);
  }
  53.333333333333336% {
  ...
  73.33333333333333% {
    clip: rect(102px, 9999px, 131px, 0);
  }
  76.66666666666667% {
  ...
  83.33333333333334% {
    clip: rect(138px, 9999px, 9px, 0);
  }
  86.66666666666667% {
    clip: rect(127px, 9999px, 101px, 0);
  }
  90% {
